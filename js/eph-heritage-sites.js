...
if (record.lat !== undefined && record.lon !== undefined) {
  ...
  let eventsHtmlPlaceholder = `
    <div id="events-container-${qid}" class="loading" style="margin-top: 3px;">
  ...
  let arsipHtml = `<div id="arsip-container-${qid}" class="loading" style="margin-top: 8px;"><div class="loader" style="width: 20px; height: 20px; border-width: 2px;"></div></div>`;
